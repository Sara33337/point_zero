...
class ExchangeRepositoryImpl implements ExchangeRepository {
  ...
  @override
  Future<Either<Failure, List<PastSaleItemEntity>>> searchPastSales(String query) async {
    try {
  ...
  Future<Either<Failure, Unit>> processExchangeTransaction({
    ...
    try {
      ...
      return Left(LocalDatabaseFailure('حدث خطأ غير متوقع أثناء تنفيذ الاستبدال: $e'));
    }
  }
}